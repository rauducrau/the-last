    ...
    <section>
         ...
         <div id="content">
            <div class="line">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=&quot;C:\Users\My Pc\Downloads\banhang.mdf&quot;;Integrated Security=True;Connect Timeout=30" DeleteCommand="DELETE FROM [hoadonct] WHERE [hoadon_id] = @hoadon_id" InsertCommand="INSERT INTO [hoadonct] ([gia], [soluong], [Sanpham_id], [hoadon_id]) VALUES (@gia, @soluong, @Sanpham_id, @hoadon_id)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [gia], [soluong], [Sanpham_id], [hoadon_id] FROM [hoadonct]" UpdateCommand="UPDATE [hoadonct] SET [gia] = @gia, [soluong] = @soluong, [Sanpham_id] = @Sanpham_id WHERE [hoadon_id] = @hoadon_id">
                    <DeleteParameters>
